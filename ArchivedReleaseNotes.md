# The JavaMelody project has moved. The new page is https://github.com/javamelody/javamelody/wiki/ReleaseNotes #
...
### Next release (trunk) ###
  ...
  * fix [issue 338](https://code.google.com/p/javamelody/issues/detail?id=338): Javamelody swallows response when some Spring WebAsyncTask/Callable is used (thanks to _Violeta Georgieva_). The [web.xml example](UserGuide#2._web.xml_file.md) in the User's guide is also changed for Async requests with Servlet API 3.0.
  * fix: in latest JIRA versions, monitoring report outputs garbage (gzip compression is now enabled by default in JIRA)

### JavaMelody migration ###
  ...
  * JavaMelody [Issues](https://github.com/javamelody/javamelody/issues), [Releases (downloads)](https://github.com/javamelody/javamelody/releases), [Release notes](https://github.com/javamelody/javamelody/wiki/ReleaseNotes), [User's guide](https://github.com/javamelody/javamelody/wiki/UserGuide) have new pages.
  * Contributors to code can now fork the github [repository](https://github.com/javamelody/javamelody) and submit [pull requests](https://github.com/javamelody/javamelody/pulls)
  * The repository of the [Grails plugin](http://www.grails.org/plugin/grails-melody) is also moved to https://github.com/javamelody/grails-melody-plugin
  * The repository of the [Liferay plugin](https://github.com/javamelody/javamelody/wiki/UserGuide#liferay-plugin) is moved to https://github.com/javamelody/liferay-javamelody
  * The repository of the [Sonar plugin](https://github.com/javamelody/javamelody/wiki/UserGuide#sonar-plugin) is moved to https://github.com/javamelody/sonar-javamelody
